            ...
            <FlatList
              ...
              renderItem={
                ...
                <TouchableHighlight
                  ...
                  onPress={() => navigation.navigate('Resgate', { valorInvestimentos: investimento.saldoTotalDisponivel, acoes: investimento.acoes })}>
                  <Text style={styles.item}>
                    {investimento.nome} - {investimento.objetivo} R$ {investimento.saldoTotalDisponivel}
                  </Text>
                </TouchableHighlight>
              }
            />
